...
{
	return IIC_Read_One_Byte(&CST816_bus,Device_Addr,addr);
}
...
{
	IIC_Write_One_Byte(&CST816_bus,Device_Addr,addr,dat);
}
...
{
	uint8_t DAT[4];
	IIC_Read_Multi_Byte(&CST816_bus,Device_Addr,XposH,4,DAT);
